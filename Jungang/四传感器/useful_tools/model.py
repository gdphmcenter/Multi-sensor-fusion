...
#
#     x = Conv1D(filters=64, kernel_size=3, strides=2, activation='linear')(x)  # linear tanh
...
#     return x
#
# def network_encoder3(x, code_size):
#
#     ''' Define the network mapping images to embeddings '''
#
#     x = Conv1D(filters=64, kernel_size=3, strides=2, activation='linear')(x)  # linear tanh
...
#     x = LeakyReLU()(x)
#
#     x = Dense(units=code_size, activation='linear', name='encoder_embedding3')(x)
#
#     return x
...
def network_encoder4(x, code_size):
    ''' Define the network mapping images to embeddings '''
...
#     encoded_model1 = tf.keras.Model(x, code_size, name='encoder1')
#     encoded_model1.summary()
#     encoded_model1.save(join(output_dir, 'network_encoder1'))
#
#     return  x
#
#
...
#     x = keras.layers.Dropout(0.2)(x)
#
#     x = keras.layers.Dense(units=16, activation='linear')(x)
#     encoded_model2 = tf.keras.Model(code_size, x, name='encoder2')
#     encoded_model2.summary()
#     encoded_model2.save(join(output_dir, 'network_encoder2'))
#
#     return x
#
#
...
#
#     x = keras.layers.Dense(units=16, activation='linear')(x)
#     encoded_model3 = tf.keras.Model(x,code_size, name='encoder3')
#     encoded_model3.summary()
#     encoded_model3.save(join(output_dir, 'network_encoder3'))
#
#     return  x
#
#
...
#
#     x = keras.layers.Dense(units=16, activation='linear')(x)
#     encoded_model4 = tf.keras.Model(x,code_size, name='encoder4')
#     encoded_model4.summary()
#     encoded_model4.save(join(output_dir, 'network_encoder4'))
#
#     return  x
...
def network_encoder(encoder_input, code_size,output_dir='model'):
    ...
    print('inputC',inputC.shape)
    print('inputD',inputD.shape)
...
# 总体网络
def network_cpc_Mat(image_shape, terms, predict_terms, code_size, learning_rate, output_dir='models'):
    ...
    # network_encoder1.save(join(output_dir, '1_encoded.h5'))
    # network_encoder2.save(join(output_dir, '2_encoded.h5'))
    # network_encoder3.save(join(output_dir, '3_encoded.h5'))
    # network_encoder4.save(join(output_dir, '4_encoded.h5'))
...
if __name__ == "__main__":
    ...
    plot_model(model, 'model7.png')  # show_shapes=True, show_dtype=True, show_layer_names=True
    model.summary()